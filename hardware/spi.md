...
* [Serial Periferal Interface, Wikipedia](https://ru.wikipedia.org/wiki/Serial_Peripheral_Interface)
* [Обзор шины SPI и разработка драйвера ведомого SPI устройства для embedded Linux (Habr)](https://habr.com/ru/post/123145/)
